            ...
            Ok(XmlEvent::StartElement {
                ...
                for attr in attrs {
                    match stack.last() {
                        ...
                        Some(&MavXmlElement::Entry) => match attr.name.local_name.clone().as_ref() {
                            "name" => {
                        ...
                        Some(&MavXmlElement::Message) => match attr.name.local_name.clone().as_ref() {
                            "name" => {
                        ...
                        Some(&MavXmlElement::Field) => match attr.name.local_name.clone().as_ref() {
                            "name" => {
